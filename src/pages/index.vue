...
<template>
  <NuxtLayout name="custom"  class="w-full overflow-hidden">
    ...
    <div class="relative w-full h-screen" >
            ...
            >
              ...
              <div class="flex flex-col justify-center w-full">
                ...
                <div class="text-4xl text-white">
                  ...
                  <span class="text-yellow-600" @click="pourcentage += 23">Nizi</span>
                  - Level {{ level }}
                </div>
      ...
      <div
        class="w-full h-screen bg-[url('~/assets/img/home.jfif')] bg-center bg-cover fixed top-0 -z-20" 
      >
      </div>
      <div
        class="absolute bottom-0 z-10 right-[15%] size-custom">
        <button @click="dialog = true" class="bg-[url('~/assets/img/kiki-background-v2.png')] w-full h-full bg-cover">
        </button>
      </div>
    </div>
  </NuxtLayout>
