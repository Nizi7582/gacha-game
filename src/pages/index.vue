...
<template>
  <NuxtLayout name="custom">
    <div class="w-full relative overflow-hidden">
      <div v-if="userStore && userStore.userData && userStore.userData.character != '' && userStore.userData.character != undefined" class="w-full h-screen">
        <div class="w-full h-full">
          <div class="flex items-start justify-between">
            <div class="flex items-center w-full h-full">
              <div class="flex w-full max-w-lg p-4 border border-gray-800 rounded-br-xl gap-x-6 bg-gradient-to-tl from-gray-300/20 via-gray-500/20 to-gray-400/20">
                <!-- <img
                src="~/assets/img/empty-avatar.jpg"
                class="border-4 border-yellow-800 rounded-full h-28"
              /> -->
                <img src="~/assets/img/empty-avatar.jpg" class="border-4 border-yellow-800 rounded-full h-28" />
                <div class="flex flex-col justify-center w-full">
                  ...
                  <div class="z-20">
                    <button @click="logout()" class="text-red-700 text-3xl">Disconnect</button>
                  </div>
                  <div class="">
                    <div class="relative">
                      <div class="p-1 border border-yellow-800 rounded-full">
                        <div class="flex items-center justify-center h-6 leading-none transition-all duration-700 bg-yellow-700 rounded-full text-md" :style="'width: ' + pourcentage + '%; height: 85%; max-width: 100%'">
      ...
      <div v-if="userStore.userData.character === ''" class="relative w-full h-screen">
        <div class="p-4">
          ...
          <div class="flex items-center justify-center py-8 rounded-lg bg-gradient-to-t from-gray-800 via-purple-900 to-blue-900">
            <div class="text-5xl text-white">Chooso cato</div>
          </div>
        </div>

        <div class="w-full h-screen bg-[url('~/assets/img/cat_choice.png')] bg-center bg-cover fixed top-0 -z-20"></div>

        <div class="absolute -bottom-[3%] hover:bottom-[9%] z-10 left-[3%] w-[27%] h-[56%] transition-all duration-[1000ms] group">
          <button @click="dialog = true" class="bg-[url('~/assets/img/cat_character3.png')] w-full h-full bg-cover hover:scale-105 duration-[1000ms] hover:w-full transition">
            <div class="flex flex-col items-center h-full px-2 pt-1 transition-all duration-700 transform border-2 border-blue-800 shadow-xl opacity-0 items-between bg-gradient-to-tl from-gray-900 via-purple-900 to-blue-900 rounded-xl group-hover:opacity-80">
        ...
        <div class="absolute -bottom-[3%] hover:bottom-[9%] z-10 left-[37%] w-[27%] h-[56%] transition-all duration-[1000ms] group">
          <button @click="dialog = true" class="bg-[url('~/assets/img/cat_character2.png')] w-full h-full bg-cover hover:scale-105 duration-[1000ms] hover:w-full transition">
            <div class="flex flex-col items-center h-full px-2 pt-1 transition-all duration-700 transform border-2 border-blue-800 shadow-xl opacity-0 items-between bg-gradient-to-tl from-gray-900 via-purple-900 to-blue-900 rounded-xl group-hover:opacity-80">
              <div class="self-start h-full p-4 text-2xl tracking-wider text-white lg:text-3xl">
                <div>Sumimasen</div>
        ...
        <div class="absolute -bottom-[4%] hover:bottom-[10%] transition-all z-10 right-[4%] w-[25%] h-[60%] duration-[1000ms] group">
          <button @click="dialog = true" class="bg-[url('~/assets/img/cat_character1.png')] group w-full h-full bg-cover hover:scale-105 duration-[1000ms] hover:w-full transition">
            <div class="flex flex-col items-center h-full px-2 pt-1 transition-all duration-700 transform border-2 border-blue-800 shadow-xl opacity-0 items-between bg-gradient-to-tl from-gray-900 via-purple-900 to-blue-900 rounded-xl group-hover:opacity-80">
              <div class="self-start h-full p-4 text-2xl tracking-wider text-white lg:text-3xl">
                <div>Kudasai</div>
